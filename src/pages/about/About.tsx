    ...
    return (
      <main className={styles.main}>
        ...
        <p className={styles.main_paragraph}>
          ...
          rutrum. In hac habitasse platea dictumst. Maecenas enim ipsum, sollicitudin ac dolor
          vitae, auctor placerat mauris. Curabitur dapibus felis nunc, vitae vestibulum lorem
          ultrices vel. Pellentesque sit amet nulla eget mauris porta suscipit. Ut eu ex in eros
          egestas blandit.
        </p>
        <p className={styles.main_paragraph}>
          ...
          aliquam pellentesque. Suspendisse ac ultricies nibh, eu fermentum est. Phasellus eros
          risus, efficitur id augue condimentum, volutpat viverra erat.
        </p>
      </main>
    );
  }
